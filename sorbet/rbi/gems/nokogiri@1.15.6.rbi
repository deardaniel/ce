...
class Nokogiri::HTML4::Document < ::Nokogiri::XML::Document
  ...
  # source://webrobots/0.1.2/lib/webrobots/nokogiri.rb#8
  def meta_robots(custom_name = T.unsafe(nil)); end

  # source://webrobots/0.1.2/lib/webrobots/nokogiri.rb#19
  def nofollow?(custom_name = T.unsafe(nil)); end

  # source://webrobots/0.1.2/lib/webrobots/nokogiri.rb#14
  ...
  # source://webrobots/0.1.2/lib/webrobots/nokogiri.rb#25
