...
class HTTP::Cookie
  ...
  # source://http-cookie/1.0.5/lib/http/cookie.rb#130
  def initialize(*args); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#643
  def <=>(other); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#569
  def acceptable?; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#550
  def acceptable_from_uri?(uri); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#546
  def accessed_at; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#546
  def accessed_at=(_arg0); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#596
  def cookie_value; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#543
  def created_at; end
  ...
  # source://http-cookie/1.0.5/lib/http/cookie.rb#386
  def domain=(domain); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#431
  def domain_name; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#426
  def dot_domain; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#659
  def encode_with(coder); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#536
  def expire!; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#526
  def expired?(time = T.unsafe(nil)); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#485
  def expires; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#490
  def expires=(t); end
  ...
  # source://http-cookie/1.0.5/lib/http/cookie.rb#438
  def for_domain; end
  ...
  # source://http-cookie/1.0.5/lib/http/cookie.rb#476
  def httponly; end
  ...
  # source://http-cookie/1.0.5/lib/http/cookie.rb#666
  def init_with(coder); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#635
  def inspect; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#504
  def max_age; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#507
  def max_age=(sec); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#347
  def name; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#350
  def name=(name); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#450
  def origin; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#453
  def origin=(origin); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#441
  def path; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#444
  def path=(path); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#470
  def secure; end
  ...
  # source://http-cookie/1.0.5/lib/http/cookie.rb#482
  def session; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#482
  def session?; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#605
  def set_cookie_value; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#596
  def to_s; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#654
  def to_yaml_properties; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#584
  def valid_for_uri?(uri); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#364
  def value; end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#367
  def value=(value); end

  # source://http-cookie/1.0.5/lib/http/cookie.rb#671
  def yaml_initialize(tag, map); end

  class << self
    # source://http-cookie/1.0.5/lib/http/cookie.rb#331
    def cookie_value(cookies); end

    # source://http-cookie/1.0.5/lib/http/cookie.rb#338
    ...
    # source://http-cookie/1.0.5/lib/http/cookie.rb#229
...
class Mechanize
  ...
  #
  # source://mechanize//lib/mechanize.rb#209
  ...
  #
  # source://mechanize//lib/mechanize.rb#742
  def add_auth(uri, user, password, realm = T.unsafe(nil), domain = T.unsafe(nil)); end

  # :section: Utilities
  #
  # source://mechanize//lib/mechanize.rb#1253
  def agent; end
  ...
  #
  # source://mechanize//lib/mechanize.rb#1102
  def ca_file; end

  # Sets the certificate file used for SSL connections
  #
  # source://mechanize//lib/mechanize.rb#1109
  def ca_file=(ca_file); end

  # An OpenSSL client certificate or the path to a certificate file.
  #
  # source://mechanize//lib/mechanize.rb#1116
  def cert; end

  # Sets the OpenSSL client certificate +cert+ to the given path or
  # certificate instance
  #
  # source://mechanize//lib/mechanize.rb#1124
  def cert=(cert); end
  ...
  #
  # source://mechanize//lib/mechanize.rb#1150
  def cert_store; end
  ...
  # See also #cert_store
  #
  # source://mechanize//lib/mechanize.rb#1159
  ...
  #
  # source://mechanize//lib/mechanize.rb#1168
  def certificate; end
  ...
  #
  # source://mechanize//lib/mechanize.rb#351
  def click(link); end

  # Are If-Modified-Since conditional requests enabled?
  #
  # source://mechanize//lib/mechanize.rb#749
  def conditional_requests; end

  # Disables If-Modified-Since conditional requests (enabled by default)
  #
  # source://mechanize//lib/mechanize.rb#756
  ...
  #
  # source://mechanize//lib/mechanize.rb#657
  ...
  #
  # source://mechanize//lib/mechanize.rb#445
  ...
  #
  # source://mechanize//lib/mechanize.rb#410
  ...
  #
  # source://mechanize//lib/mechanize.rb#668
  def html_parser; end
  ...
  #
  # source://mechanize//lib/mechanize.rb#832
  ...
  # value may help.
  #
  # source://mechanize//lib/mechanize.rb#840
  ...
  #
  # source://mechanize//lib/mechanize.rb#880
  ...
  # connections
  #
  # source://mechanize//lib/mechanize.rb#675
  ...
  #
  # source://mechanize//lib/mechanize.rb#904
  ...
  #
  # source://mechanize//lib/mechanize.rb#921
  ...
  # response body size
  #
  # source://mechanize//lib/mechanize.rb#275
  def max_history; end
  ...
  #
  # source://mechanize//lib/mechanize.rb#289
  def max_history=(length); end

  # Length of time to wait until a connection is opened in seconds
  #
  # source://mechanize//lib/mechanize.rb#928
  def open_timeout; end

  # Sets the connection open timeout to +open_timeout+
  #
  # source://mechanize//lib/mechanize.rb#935
  ...
  #
  # source://mechanize//lib/mechanize.rb#1259
  def parse(uri, response, body); end

  # OpenSSL client key password
  #
  # source://mechanize//lib/mechanize.rb#1190
  def pass; end

  # Sets the client key password to +pass+
  #
  # source://mechanize//lib/mechanize.rb#1197
  def pass=(pass); end
  ...
  #
  # source://mechanize//lib/mechanize.rb#687
  ...
  #
  # source://mechanize//lib/mechanize.rb#529
  ...
  #
  # source://mechanize//lib/mechanize.rb#330
  ...
  #
  # source://mechanize//lib/mechanize.rb#338
  def pre_connect_hooks; end

  # source://mechanize//lib/mechanize.rb#1286
  def pretty_print(q); end

  # The HTTP proxy address
  #
  # source://mechanize//lib/mechanize.rb#692
  def proxy_addr; end

  # The HTTP proxy password
  #
  # source://mechanize//lib/mechanize.rb#697
  def proxy_pass; end

  # The HTTP proxy port
  #
  # source://mechanize//lib/mechanize.rb#702
  def proxy_port; end

  # The HTTP proxy username
  #
  # source://mechanize//lib/mechanize.rb#707
  def proxy_user; end
  ...
  #
  # source://mechanize//lib/mechanize.rb#950
  ...
  #
  # source://mechanize//lib/mechanize.rb#1318
  def shutdown; end

  # SSL version to use.
  #
  # source://mechanize//lib/mechanize.rb#1204
  def ssl_version; end

  # Sets the SSL version to use to +version+ without client/server
  # negotiation.
  #
  # source://mechanize//lib/mechanize.rb#1212
  ...
  #
  # source://mechanize//lib/mechanize.rb#1083
  ...
  #
  # source://mechanize//lib/mechanize.rb#1224
  def verify_callback; end

  # Sets the OpenSSL certificate verification callback
  #
  # source://mechanize//lib/mechanize.rb#1231
  ...
  #
  # source://mechanize//lib/mechanize.rb#1240
  def verify_mode; end

  # Sets the OpenSSL server certificate verification method.
  #
  # source://mechanize//lib/mechanize.rb#1247
  ...
  # @return [Boolean]
  #
  # source://mechanize//lib/mechanize.rb#296
  def visited?(url); end
  ...
  # content
  #
  # source://mechanize//lib/mechanize.rb#1092
  ...
  #
  # source://mechanize//lib/mechanize.rb#1350
  def add_to_history(page); end

  # Posts +form+ to +uri+
  #
  # source://mechanize//lib/mechanize.rb#1328
  ...
  class << self
    ...
    #
    # source://mechanize//lib/mechanize.rb#642
    def html_parser; end
    ...
    # source://mechanize//lib/mechanize.rb#168
    ...
    #
    # source://mechanize//lib/mechanize.rb#649
    def log; end
...
# pair.
#
# source://mechanize//lib/mechanize/form/keygen.rb#9
